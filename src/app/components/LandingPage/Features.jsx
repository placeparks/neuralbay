    ...
    <div className="md:pb-20 pb-12 pt-8 md:pt-0">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 mt-20 md:p-0 p-4">
        <div className="flex flex-col items-left justift-start gap-8">
          ...
          <a
            href="#"
            className="flex flex-col font-sans items-center bg-bluecustom border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
          >
            <div className="flex flex-col justify-between p-12 ">
              <h5 className="mb-2 text-3xl font-sans font-semibold leading-10 tracking-tight text-gray-900 dark:text-white">
                Secured By Blockchain Tech
              </h5>
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                Neuralbay is the ultimate AI Model Marketplace, offering a wide
                selection of state-of-the-art AI models created by talented AI
          ...
          <a
            href="#"
            className="flex flex-col font-sans items-center bg-yellowcustom border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
          >
            <div className="flex flex-col justify-between p-12 ">
              <h5 className="mb-2 text-3xl font-sans font-semibold leading-10 tracking-tight text-gray-900 dark:text-white">
                Upload and Monitize
        ...
        <div class="md:max-w-lg md:h-xl bg-pinkcustom border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 md:pt-32 p-4">
          <div className="flex items-center justify-center">
            <a href="#">
              <Image
                className="rounded-t-lg md:-mt-14 md:mb-10 "
          ...
          <div className="p-5">
            <h5 className="mb-2 text-3xl md:w-3/6 font-sans font-semibold leading-10 tracking-tight text-gray-900 dark:text-white">
