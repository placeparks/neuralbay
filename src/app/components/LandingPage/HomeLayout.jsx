  ...
  return (
    ...
    <BackgroundGradientAnimation>
      ...
      <Image src='/assets/WELCOME.png' height={300} width={300} alt=""  />
        ...
        <p className="md:text-lg text-md font-normal pl-4 pr-4 md:pl-8 md:pr-8 md:pl-80 md:pr-80 mb-8" >A platform that allows individuals and organisations to buy and sell pretrained AI models and services securely and transparently using blockchain technology</p>
