...
const Questions = () => {
  return (
    <div className="container my-24 mx-auto px-6 xl:px-24">
       ...
       <p className='text-gray-400 text-center w-full mb-4 md:mb-12 md:w-3/4'>Our FAQ area is the best place to look to find answers to your questions. Our community and support team constantly updates the questions and answers.</p>
              </div>
